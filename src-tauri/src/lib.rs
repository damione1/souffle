...
pub mod native_shortcut;
pub mod native_single_instance;
pub mod native_tray;
...
fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::get_native_shortcuts,
            commands::get_settings_options,
            ...
            commands::peek_sleep_paused_meeting,
            commands::clear_sleep_paused_meeting,
            ...
            commands::export_meeting_audio_filename,
            commands::export_meeting_audio_to_file,
            commands::save_meeting_audio_export,
