...
- `./scripts/bundle-slint-release.sh` builds the native Slint Rust application (`souffle-slint`) in release mode, bundles it into `Souffle.app`, and packages it into a `.dmg`.
