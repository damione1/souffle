...
Private, on-device speech-to-text for macOS (Apple Silicon only). Rust backend + native Slint UI in `src-tauri/` (binary crate `souffle-slint`). No webview in the shipped app.
