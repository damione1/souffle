...
- `make nightly` builds the debug app as **Soufflé Nightly** (`com.souffle.desktop.nightly`) and opens it; `make nightly-dmg` wraps it in a `.dmg`. Does not touch the installed Soufflé.
